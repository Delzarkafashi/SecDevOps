...
VALUES
  ('viewer@demo.local', crypt('Viewer123!', gen_salt('bf')), 'viewer'),
  ('staff@demo.local',  crypt('Staff123!',  gen_salt('bf')), 'staff'),
  ('admin@demo.local',  crypt('Admin123!',  gen_salt('bf')), 'admin')
